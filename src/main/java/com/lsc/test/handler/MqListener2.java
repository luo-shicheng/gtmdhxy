...
public class MqListener2  implements RocketMQListener<MessageExt>, RocketMQPushConsumerLifecycleListener {
    @Override
    public void onMessage(MessageExt messageExt) {
        System.out.println(new Date()+"         "+"MqListener2    "+Thread.currentThread().getName()+"   "+messageExt.getQueueId()+"    "+new String(messageExt.getBody()));
